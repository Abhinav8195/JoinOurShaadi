...
export default function Header() {
  ...
  return (
    ...
    >
              ...
              <div className="">
                <SignInButton mode="modal">
                  <button
                    ...
                    data-aos-delay="300"
                  >
                    <span className="relative z-10 text-[#747afb]">Login</span>
                     <div className="absolute inset-0 bg-gradient-to-r from-rose-100 to-pink-100 rounded-lg scale-0 group-hover:scale-100 transition-transform duration-300 ease-out"></div>
                <div className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-rose-500 to-pink-500 group-hover:w-full group-hover:left-0 transition-all duration-300"></div>
                  </button>
                </SignInButton>
      ...
      >
        <div className="bg-white/10 backdrop-blur-2xl border border-white/20 shadow-2xl rounded-xl mx-4 mt-2">
            ...
            {isSignedIn ? (
             ...
             <SignInButton mode="modal">
                <button
                  ...
                  data-aos-delay="300"
                >
                  <span className="relative z-10 group-hover:text-rose-600 transition-colors duration-300 text-[#747afb]">Login</span>
                  <div className="absolute inset-0 bg-gradient-to-r from-rose-100 to-pink-100 rounded-lg scale-0 group-hover:scale-100 transition-transform duration-300 ease-out"></div>
                <div className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-gradient-to-r from-rose-500 to-pink-500 group-hover:w-full group-hover:left-0 transition-all duration-300"></div>
