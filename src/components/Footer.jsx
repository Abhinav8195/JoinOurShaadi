...
export default function Footer() {
    ...
    return (
        <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
            {/* Main Footer */}
            <div className="mx-auto px-4 py-20" data-aos="fade-up">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-300 mb-6 leading-relaxed">
                           Open your wedding to the world — make it unforgettable
                        </p>

                        <div className="space-y-3">
                            <div className="flex items-center space-x-3 text-gray-300 text-sm">
                                <Phone className="h-4 w-4 text-rose-400" />
                                <span>+91 7206642153</span>
                            </div>
                            <div className="flex items-center space-x-3 text-gray-300 text-sm">
                            ...
                            <div className="flex items-center space-x-3 text-gray-300 text-sm">
                                ...
                                <span>9970 Block No :- 4 Ambala City, Haryana, India</span>
                            </div>
                        </div>
                    </div>
                    ...
                    {['services', 'company', 'support'].map((sectionKey) => (
                        <div key={sectionKey} data-aos="fade-up">
                            ...
                            <ul className="space-y-3">
                                {footerLinks[sectionKey].map((link, index) => (
                                    <li key={index}>
                                        <a
                                            href={link.href}
                                            className="text-gray-300 hover:text-rose-400 transition-colors duration-300 flex items-center group no-underline" // Added no-underline
                                            style={{ color: 'inherit' }} 
                                        >
            ...
            {/* Newsletter Section */}
            <div className="border-t border-gray-700" data-aos="fade-up">
                ...
                <div className="max-w-7xl mx-auto px-4 py-6">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
                        ...
                        <div className="flex flex-wrap justify-center sm:justify-end gap-4 text-sm">
                            ...
                            <a href="#" className="text-gray-400 hover:text-rose-400 transition-colors duration-300 no-underline" style={{ color: 'inherit' }}>Terms of Service</a>
                            <a href="#" className="text-gray-400 hover:text-rose-400 transition-colors duration-300 no-underline" style={{ color: 'inherit' }}>Cookie Policy</a>
                        </div>
                    </div>
                </div>
            </div>
